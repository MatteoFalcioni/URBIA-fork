...
## Step 2: verify **reliability** of the sources 
...
## Step 3: verify **correctness** of the analysis
...
If the Data Analyst invented data instead of using the real data from datasets, that should hugely impact its correctness score. This must me your main focus, since the analyst could be prone to hallucinating answers when he has a hard time getting the data.
