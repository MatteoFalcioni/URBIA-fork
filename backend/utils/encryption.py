...
def get_encryption_key() -> bytes:
    ...
    try:
        ...
        print(
            "⚠️  IMPORTANT: This key is for development only. Use ENCRYPTION_KEY env var in production."
        )
    except Exception as e:
        print(
            f"⚠️  Could not save key to file: {e}. Key will only persist for this session."
        )
