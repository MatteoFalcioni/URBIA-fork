...
1. User provides multiple tasks - When users provide a list of things to be done (numbered or comma-separated)
2. User explicitly requests todo list - When the user directly asks you to use the todo list
3. The plan may need future revisions or updates based on results from the first few steps
