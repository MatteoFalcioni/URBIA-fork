...
## Step 2: verify **completeness** of the analysis

If no errors external to the analyst occured, you will then assess if the analysis objectives were met.
...
You will do so by checking code logs, to verify that the analyst did not invent results to satisfy the user, and that he did perform a meaningful analysis given its objectives.
